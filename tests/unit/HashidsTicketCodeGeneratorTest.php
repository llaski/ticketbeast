...
class HashidsTicketCodeGeneratorTest extends TestCase
{
    ...
    function ticket_codes_for_the_same_ticket_id_are_the_same()
    {
        ...
        $codeOne = $ticketCodeGenerator->generateFor(new Ticket(['id' => 1]));
        $codeTwo = $ticketCodeGenerator->generateFor(new Ticket(['id' => 1]));
    ...
    function ticket_codes_for_different_ticket_ids_are_different()
    {
        ...
        $codeOne = $ticketCodeGenerator->generateFor(new Ticket(['id' => 1]));
        $codeTwo = $ticketCodeGenerator->generateFor(new Ticket(['id' => 2]));
    ...
    function ticket_codes_generated_with_different_salts_are_different()
    {
        ...
        $codeOne = $ticketCodeGenerator1->generateFor(new Ticket(['id' => 1]));
        $codeTwo = $ticketCodeGenerator2->generateFor(new Ticket(['id' => 1]));
