...
class ViewPublishedConcertOrdersTest extends TestCase
{
    ...
    /** @test */
    public function aPromoterCanViewTheOrdersOfTheirOwnPublishedConcert()
    {
    ...
    /** @test */
    public function aPromoterCanViewThe10MostRecentOrdersForTheirConcert()
    {
        $user = factory(User::class)->create();
        $concert = ConcertFactory::createPublished(['user_id' => $user->id]);
    ...
    /** @test */
    public function aPromoterCannotViewTheOrdersOfUnpublishedConcerts()
    {
        $user = factory(User::class)->create();
    ...
    /** @test */
    public function aPromoterCannotViewTheOrdersOfAnotherPublishedConcert()
    {
        $user = factory(User::class)->create();
    ...
    /** @test */
    public function aGuestCannotViewTheOrdersOfAnyPublishedConcert()
    {
